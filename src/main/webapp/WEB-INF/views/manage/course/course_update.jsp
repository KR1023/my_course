	...
	<div class="wrapper">
		...
		<div class="input_container">
			...
			<div class="course_info">
				<div class="title">
					<span>강좌명</span>
					<input id="course_name" type="text" placeholder="강좌명" disabled value="${ course.courseName}"/>
				</div>
				<div class="attendee">
					<span>수강 인원</span>
					<select id="sel_max" disabled>
...
<!-- 					<input type="text" placeholder="수강 인원"/> -->
				...
				<div class="closing_date">
					<span>신청 마감일</span>
					<input id="sel_date" type="date" required placeholder="마감일" disabled value="${course.closeDt}"/>
				</div>
				<div class="btn_container">
					<button id="add_btn" onClick="updateCourse()">강좌수정</button>
				</div>
			</div>
		</div>
